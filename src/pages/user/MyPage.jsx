      ...
      <main className="pt-[64px] md:pt-24 pb-20 md:pb-24 px-4 md:px-gutter max-w-max-width mx-auto">
        ...
        <div className="flex flex-col gap-8 max-w-4xl">
          ...
          <section className="bento-card p-4 md:p-8">
            ...
            <p className="text-sm text-text-sub mb-4">비밀번호는 별도 페이지에서 변경할 수 있습니다.</p>
            <button onClick={() => navigate('/change-password')} className="px-6 py-2.5 border border-primary text-primary font-bold rounded-lg text-sm hover:bg-primary/5 inline-flex items-center gap-2">
